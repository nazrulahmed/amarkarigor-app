...
import 'package:amar_karigor/app/modules/category/controllers/category_controller.dart';
...
class CategoryServices extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    children: [
      ...
      Container(
          child: categoryController.servicesInCategory.length == 0
              ? ListView.builder(
              ...
              : ListView.builder(
                  itemCount: categoryController.servicesInCategory.length,
                  shrinkWrap: true,
                  physics: ClampingScrollPhysics(),
                  itemBuilder: (context, index) {
                    return service(categoryController.servicesInCategory[index]);
                  })),
    ],
  );
