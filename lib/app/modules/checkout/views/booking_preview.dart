...
class BookingPreview extends GetView<CheckoutController> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: GetBuilder(
            builder: (CheckoutController checkoutController) => controller
                        .booking ==
                    null
                ? SizedBox()
                : Padding(
                    ...
                    child: Center(
                      child: Container(
                        ...
                        width: isDesktopView(context)
                            ...
                            : double.infinity,
                        padding:
                            isDesktopView(context) ? EdgeInsets.all(20) : null,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Card(
                                    child: Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: ServiceAttribute(
                                      controller.booking!.selectedOptions),
                                )),
                                SizedBox(height: 16),
                                Center(
                                  child: Row(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(children: [
                                              ...
                                              Row(children: [
                                                ...
                                                SizedBox(width: 5),
                                                Text(
                                                    '${controller.booking!.bookingDate}',
                                                    style: MyTextStyle
                                                        .textGreenMediumBold)
                                              ]),
                                            ]),
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(children: [
                                              ...
                                              Row(children: [
                                                ...
                                                SizedBox(width: 5),
                                                Text(
                                                    '${controller.booking!.bookingTime}',
                                                    style: MyTextStyle
                                                        .textGreenMediumBold)
                                              ]),
                                            ]),
