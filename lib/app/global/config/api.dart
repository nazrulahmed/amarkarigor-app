class Api {
  static String base_url = 'http://nazrulahmed.xyz/amarkarigor/api/v1/';
  static String ssl_payment_url = 'https://nazrulahmed.xyz/amarkarigor/api/v1/';
  static String assets_url = 'https://nazrulahmed.xyz/amarkarigor/api/assets/';
  static String banners = "banners/";
  static String categories_icon = "categories/";
